...
**Hello Rails Back-End** is an app where I created a greeting API to be called in [this front-end project](https://github.com/Haywayaheadshot/hello-react-front-end)
...
```
- To clone the repository run this command - "https://github.com/Haywayaheadshot/hello-rails-back-end.git"
